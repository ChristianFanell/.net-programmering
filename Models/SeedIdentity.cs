...
namespace LabbUppgift3.Models
{
    ...
    {
        // allt är efterapat från föreläsning
        ...
        {
            //IdentityUser leffe = new IdentityUser("Adminuser");
            //await uManager.CreateAsync(leffe, "Bajskorv!");// lösenordspolicy services.AddIntetity<>(options => )
            //await uManager.AddToRoleAsync(leffe, "Coordinator");
            ...
            await uManager.CreateAsync(E301, "Pass11?"); // Lena Larsson
            ...
            await uManager.CreateAsync(E500, "Pass18?"); // exempel
